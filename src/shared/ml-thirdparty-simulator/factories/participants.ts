...
/**
 * Number of participants that will be generated by the simulator.
 * 
 * TODO: customize the number of participants using the configs passed
 * to the Mojaloop simulator upon initialization.
 */
